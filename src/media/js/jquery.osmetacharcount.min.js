...
if(length>1){$this.counterText.text(options.charPluralStr);}else{$this.counterText.text(options.charStr);}};$this.on('keyup',function(){$this.update();});addElements();$this.update();});}};})(jQuery);