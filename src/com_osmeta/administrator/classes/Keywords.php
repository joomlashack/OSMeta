...
require_once JPATH_ADMINISTRATOR.DS."components".
        DS."com_osmeta".DS."algorithm".DS."GoogleKeywordRank.php";
...
class Keywords{
    ...
    $sql = "UPDATE #__osmeta_keywords SET google_rank=".$db->quote($rank).", google_rank_change=".$db->quote($change).",
